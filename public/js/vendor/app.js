...
/*
var msgModifiers = new protobuf.Controller.Modifiers();
msgModifiers.setShift(true);

var msgController = new protobuf.Controller();
msgController.setMoveforward(true);
msgController.setMovebackward(true);
msgController.setRotateleft(true);
msgController.setModifiers(msgModifiers);

var bytes = msgController.serializeBinary();

var msgIn = protobuf.Controller.deserializeBinary(bytes);

//alert(msgIn.getModifiers().getShift());
*/
...
Ticker = function (amplitude) {
	...
	this.tick = function () {
		...
		// Protobuf begin
		var msgController = new protobuf.Controller();
		msgController.setMoveforward(controller.moveForward);
		msgController.setMovebackward(controller.moveBackward);
		msgController.setMoveleft(controller.moveLeft);
		msgController.setMoveright(controller.moveRight);
		msgController.setRotateleft(controller.rotateLeft);
		msgController.setRotateright(controller.rotateRight);

		var msgModifiers = new protobuf.Controller.Modifiers();
		msgModifiers.setShift(controller.modifiers.shift);
		msgModifiers.setCtrl(controller.modifiers.ctrl);
		msgModifiers.setAlt(controller.modifiers.alt);
		msgModifiers.setMeta(controller.modifiers.meta);
